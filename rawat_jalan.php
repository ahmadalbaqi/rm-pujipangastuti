...
<body>
                      ...
                      <div class="wizard-pane">
                        <?php if (empty($_POST)) { ?>
                          ...
                          <div class="form-group row align-items-center">
                            <label class="col-md-4 text-md-right text-left">Nama Pasien</label>
                            <div class="col-lg-4 col-md-6">
                              <input id="myInput" type="text" class="form-control" name="nama" placeholder="Masukkan Nama Pasien">
  ...
  include "template/autocomplete.php"; ?>
</body>
