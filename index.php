...
<head>
  ...
  include 'function/tgl_ind.php';

  $admin = mysqli_query($conn, "SELECT * FROM user WHERE pekerjaan='1'");
  $jumlahadmin = mysqli_num_rows($admin);
  $tenagamedis = mysqli_query($conn, "SELECT * FROM user WHERE pekerjaan='2' OR pekerjaan='3' OR pekerjaan='4' ");
  $jumlahtenagamedis = mysqli_num_rows($tenagamedis);
